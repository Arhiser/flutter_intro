...
import 'package:flutter_app_tutorial/Parser.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _calculate() {
    setState(() {
      ...
      try {
        _resulMessage = "Результат: " + parser.expr(lexemeBuffer).toString();
      } on ParseException catch(e) {
        _resulMessage = "Ошибка: " + e.couse;
      }
    });
  }
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: TextField(
                ...
                onChanged: (text) {_textEntered = text;},
                inputFormatters: [
